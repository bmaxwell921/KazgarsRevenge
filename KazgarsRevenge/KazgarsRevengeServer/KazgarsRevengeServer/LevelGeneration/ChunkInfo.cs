...
namespace KazgarsRevengeServer
{
    ...
    {
        /*
         * TODO: Doing it this way means I have to duplicate all the chunkInfos when
         * something can be rotated. Maybe add rotation in here?
         */ 

        // Which 'directions' of this chunk have doors
        public ISet<Direction> doorDirections;
